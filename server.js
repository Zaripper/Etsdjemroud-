...
function publicView(p) {
  return { id: p.id, name: p.name, category: p.category, brand: p.brand, qty: p.qty, price: p.price, unit: p.unit, image: p.image || null };
}
...
const HEADER_MAP = {
  ...
  name: ['name', 'nom', 'désignation', 'designation', 'article', 'produit'],
  category: ['category', 'catégorie', 'categorie'],
  brand: ['brand', 'marque'],
  qty: ['qty', 'quantite', 'quantité', 'stock'],
  price: ['price', 'prix', 'prix vente', 'prix de vente'],
  cost: ['cost', 'cout', 'coût', 'prix achat', "prix d'achat"],
